"""
Calculate total moles of helium-3 in the cryogenic system.
"""

import numpy as np


def calculate_total_n_he3(Q_dot, operating_hours, latent_heat, p_cool, v_mole, v_evap, temp_evap, v_pump, temp_pump, length, diameter_tube, int_points, temp_pump_val, temp_evap_val):
    """
    Calculate total moles of helium-3 including evaporation, evaporator, pump, and tube components.
    ...
    n_l_3 = calculate_evaporation(Q_dot, operating_hours, latent_heat)
    
    # Helium in evaporator
    n_e = p_cool * (v_evap - n_l_3 * v_mole) / (8.31 * temp_evap)
